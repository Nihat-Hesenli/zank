            ...
            <div ref={shoesRef}  className={styles.winter_section}>
                ...
                <div className={styles.Featured_section}>
                    ...
                    <div className={styles.shoe_cards}>
                        ...
                        <div className={styles.card}>
                            ...
                            <div className={styles.discountTag}>%15</div>

                            <div className={styles.info}>
                                <h3 className={styles.model}>Nike Pegasus Turbo</h3>
                                <p className={styles.price}>$760.00</p>
                            </div>
                ...
                <div className={styles.thisMonth_Section}>
                    ...
                    <div className={styles.shoe_cards}>
                        ...
                        {/* <div className={styles.card}>
                            <img src={thisMonthPhoto} className={styles.image} />

                            <div className={styles.saleTag}>SALE</div>
                            <div className={styles.discountTag}>%6</div>

                            <div className={styles.info}>
                                <h3 className={styles.model}>Nike Pegasus Turbo</h3>
                                <div className={styles.priceRow}>
                                    <p className={styles.oldPrice}>$320.00</p>
                    ...
                    <div className={styles.trendProducts_section}>
                        ...
                        <div className={styles.shoe_cards}>
                            ...
                            {/* 
                            <div className={styles.card}>
                                <img src={trendProducts} className={styles.image} />

                                <div className={styles.saleTag}>BEST</div>
                                <div className={styles.discountTag}>%9</div>

                                <div className={styles.info}>
                                    <h3 className={styles.model}>Nike Zoom</h3>
                                    <p className={styles.price}>$10.00 - $11.00</p>
                                </div>
