...
const InStockIcon = ({ width = 512, height = 512 }) => (
  <svg
    className="svgInstock zank-svg-icon"
    height={height}
    viewBox="0 0 512 512"
    width={width}
  ...
  >
    ...
    ></path>
    <path
      d="m156.467 173.837 205.133-91.17-26.265-11.673-205.133 91.17z"
      fill="#fbab01"
    ></path>
    <circle cx="373.333" cy="362.667" fill="#00cf66" r="96"></circle>
    <path
