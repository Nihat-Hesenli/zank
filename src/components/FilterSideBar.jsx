  ...
  return (
    ...
    <aside className="filter-sidebar">
      ...
      <div className="filter-group">
        <label><input type="checkbox" /> Free Metcon</label>
        <label><input type="checkbox" /> Men's Shoes</label>
        <label><input type="checkbox" /> Nike City</label>
        <label><input type="checkbox" /> Nike Dunk</label>
        <label><input type="checkbox" /> Uncategorized</label>
        <label><input type="checkbox" /> Women's Shoes</label>
      </div>
